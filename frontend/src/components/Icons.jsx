...
export const IconCompare = (p) => (
  <Svg {...p}><path d="M8 3v18M16 3v18" /><path d="m5 7-3 3 3 3M19 7l3 3-3 3" /></Svg>
);
export const IconPhone = (p) => (
  <Svg {...p}><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3.1-8.6A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1.9.3 1.8.6 2.7a2 2 0 0 1-.4 2.1L8 9.9a16 16 0 0 0 6 6l1.4-1.4a2 2 0 0 1 2.1-.4c.9.3 1.8.5 2.7.6a2 2 0 0 1 1.8 2.2z" /></Svg>
);
export const IconStar = (p) => (
  <Svg {...p}><path d="m12 2 3.1 6.7 7.4.7-5.6 5 1.6 7.3-6.5-3.8-6.5 3.8 1.6-7.3-5.6-5 7.4-.7z" /></Svg>
);
export const IconTv = (p) => (
  <Svg {...p}><rect x="3" y="6" width="18" height="13" rx="2" /><path d="m8 3 4 3 4-3M12 19v2M8 21h8" /></Svg>
);
export const IconWallet = (p) => (
  <Svg {...p}><path d="M3 7a2 2 0 0 1 2-2h13a1 1 0 0 1 1 1v3M3 7v11a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4M3 7l4-4h9" /><circle cx="17" cy="14" r="1.2" fill="currentColor" stroke="none" /></Svg>
);
